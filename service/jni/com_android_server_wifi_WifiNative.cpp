...
static jboolean android_net_wifi_setApMode(JNIEnv* env, jobject, jboolean type)
{
    return (jboolean)(::wifi_set_mode(type ? 1 : 0) == 0);
}
...
static JNINativeMethod gWifiMethods[] = {
    ...
    { "setMode", "(Z)Z", (void*) android_net_wifi_setMode},
