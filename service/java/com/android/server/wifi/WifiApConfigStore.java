...
class WifiApConfigStore extends StateMachine {
    ...
    private void setDefaultApConfiguration() {
        ...
        config.SSID = mContext.getResources().getString(
                org.cyanogenmod.platform.internal.R.string.def_wifi_wifihotspot_ssid);
        if (TextUtils.isEmpty(config.SSID)) {
            config.SSID = mContext.getString(R.string.wifi_tether_configure_ssid_default);
        }

        boolean set_security_none = mContext.getResources().getBoolean(
                org.cyanogenmod.platform.internal.R.bool.set_wifi_hotspot_security_none);
        ...
        config.preSharedKey = mContext.getResources().getString(
                org.cyanogenmod.platform.internal.R.string.def_wifi_wifihotspot_pass);
